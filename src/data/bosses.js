...
export const BOSSES = [
  ...
  },
  {
    ...
    chapter: 3,
    name: "수은",
    epithet: "형태가 없어 붙잡히지 않는 도둑",
    level: 12,
    hpMult: 4.2,
    x: 96, z: -84,
    // 장(章) 플래그로 연다 — 퀘스트가 열어 주기 전에 나타나면 이야기와 어긋난다
    condition: "chapter3",
  ...
  },
  {
    ...
    // 규소의 예언(4장)을 들은 뒤에만 — 설득할 수 있다는 걸 모르면 그냥 죽인다
    condition: "chapter5",
    intro: [
  ...
  },
  {
    ...
    // 오가네손에게 답한 뒤에만 — 동행 여부가 엔딩을 가르므로 그 전에 끝나면 안 된다
    condition: "chapter7",
    intro: [
      "오홋♪ 손님이네. 나랑 홍차 한잔 할래?",
