...
export const ELEMENTS = [
  // ---------------- 화로 연합 ----------------
  {
    ...
    // 인연: 섞어 씀 — 탄소로 강철, 망가니즈로 질긴 강철, 니켈로 안 녹스는 강철
    bonds: ["c", "mn", "ni"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 코발트는 니켈 광석에 섞여 나온다. 셋 다 자석에 붙는다
    bonds: ["ni", "fe", "cr"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 니켈·구리는 같은 광상에서 나오고, 철과 섞어 스테인리스가 된다
    bonds: ["fe", "co", "cu"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 쇳물에서 산소를 걷어내는 일을 규소·알루미늄과 나눠 한다
    bonds: ["fe", "si", "al"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 타이타늄 합금은 대개 알루미늄·바나듐을 넣는다
    bonds: ["fe", "al", "v"],
  ...
  // ---------------- 귀금속 귀족 ----------------
  {
    ...
    // 인연: 함께 남 — 백금족은 한 광석에서 같이 나와 서로 갈라내기 어렵다
    bonds: ["pd", "ir", "au"],
  ...
  },
  {
    ...
    // 인연: 같은 줄 — 11족 셋. 잘 늘어나고 전기가 잘 통한다
    bonds: ["ag", "cu"],
  ...
  },
  {
    ...
    // 인연: 같은 줄 + 섞어 씀 — 11족이고, 브로민과 만나 사진 감광지가 된다
    bonds: ["au", "cu", "br"],
  ...
  },
  {
    ...
    // 인연: 같은 줄 + 함께 남 — 18족이고, 아르곤은 포타슘이 무너져 생긴다
    bonds: ["ne", "he", "k"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 우라늄이 무너지는 길목에 라듐·라돈·폴로늄이 차례로 있다
    bonds: ["u", "ra", "po"],
  ...
  // ---------------- 결원단 (할로겐) ----------------
  {
    ...
    // 인연: 섞어 씀 + 같은 줄 — 소듐과 소금, 플루오린과 같은 17족
    bonds: ["na", "k", "f"],
  ...
  },
  {
    ...
    // 인연: 같은 줄 + 섞어 씀 — 17족이고, 은과 만나 사진이 된다
    bonds: ["cl", "ag", "f"],
  ...
  // ---------------- 추방된 방사성 원소 ----------------
  {
    ...
    // 인연: 서로 씀 — 우라늄은 무너지고 무너져 끝내 납이 된다
    bonds: ["rn", "po", "pb"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 몰리브데넘에서 만들어지고 루테늄으로 무너진다
    bonds: ["mo", "ru"],
  ...
  // ---------------- 중립 학자·주민 ----------------
  {
    ...
    // 인연: 섞어 씀 — 살아 있는 것은 거의 이 넷으로 되어 있다
    bonds: ["o", "h", "n"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 바위의 대부분이 규소와 산소다. 알루미늄까지 셋이 흔하다
    bonds: ["o", "al", "c"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 황화물 광석. 철·구리·납이 다 황과 붙어 땅에 있다
    bonds: ["fe", "cu", "pb"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 구리에 조금 넣으면 튀지 않는 연장이 된다
    bonds: ["cu", "al", "mg"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 구리와 황동, 철 대신 자기가 먼저 삭아 준다
    bonds: ["cu", "fe", "pb"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 잘 녹는 합금. 넷을 섞으면 끓는 물에도 녹는다
    bonds: ["pb", "sn", "sb"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 금·은을 녹여 붙잡는다. 땅에서는 황과 붙어 나온다
    bonds: ["au", "ag", "s"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 — 활자 합금 셋. 광석에서는 황과 붙어 있다
    bonds: ["pb", "sn", "s"],
  ...
  },
  {
    ...
    // 인연: 함께 남 — 나이오븀과 탄탈럼은 같은 돌에서 나와 갈라내기 어렵다
    bonds: ["ta", "ti", "fe"],
  ...
  },
  {
    ...
    // 인연: 같은 줄 + 함께 남 — 1족이고, 바닷물과 밭에 소듐·염소와 함께 있다
    bonds: ["na", "cl", "ar"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 + 같은 줄 — 염소와 소금, 포타슘·리튬과 같은 1족
    bonds: ["cl", "k", "li"],
  ...
  },
  {
    ...
    // 인연: 섞어 씀 + 같은 줄 — 칼슘과 만나 형석이 된다. 17족
    bonds: ["ca", "cl", "br"],
  ...
  },
  {
    ...
    // 인연: 함께 남 + 섞어 씀 — 바위에 규소·산소와 함께 있고, 마그네슘과 섞어 가볍게 쓴다
    bonds: ["o", "si", "mg"],
