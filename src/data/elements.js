...
export const ELEMENTS = [
  ...
  },
  {
    ...
    faction: "neutral", role: "밭을 지키는 노인",
    bio: "소듐보다 한 칸 아래에 있어 전자를 더 쉽게 내준다. 그래서 물에 닿으면 소듐보다 격렬하게 터진다. 식물을 길러 대륙을 먹여 살리지만, 정작 자신은 무엇에도 오래 머물지 못한다.",
    quote: "아래로 갈수록 더 쉽게 내주게 되지. 그게 1족의 숙명이야.",
    bonds: ["na", "ar", "cl"],
  ...
  },
  {
    ...
    faction: "neutral", role: "가장 오래된 방랑자",
    bio: "우주에서 가장 먼저 태어났고 가장 많은 원소. 어느 족에도 완전히 속하지 않아 주기율표 꼭대기에 홀로 놓여 있다. 그래서 이름도 족도 없는 119번에게 유일하게 친근하게 말을 건다.",
    quote: "나도 내 자리가 어딘지 몰라. 그래도 여태 잘 살아왔는걸.",
    bonds: ["o", "c", "uue"],
  ...
  },
  {
    ...
    faction: "neutral", role: "물가에 못 가는 요리사",
    bio: "전자 하나를 너무 쉽게 내주는 탓에 물만 닿으면 폭발한다. 요리를 사랑하지만 주방에 들어갈 수 없어, 염소와 짝을 이뤄 소금이 될 때만 마음껏 음식에 들어간다.",
  ...
  },
  {
    ...
    faction: "affinity", role: "전자 친화팀 최흉의 전력",
    bio: "모든 원소 중 전자를 빼앗는 힘이 가장 강하다. 염소가 그를 팀에 들인 것은 힘 때문이지만, 정작 본인은 누구의 편도 아니다. 닿는 것 전부에서 전자를 앗아가므로 아군조차 곁에 서기를 꺼린다.",
    quote: "빼앗는 데 이유가 필요해? 나는 그렇게 생겨먹었을 뿐이야.",
    bonds: ["cl", "ca", "br"],
