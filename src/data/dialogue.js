...
//   인   — 밤새 불을 지키는 등지기. 불씨를 나르고, 뼈 속에도 들어 있다
...
export const DIALOGUES = {
  ...
  c: {
    ...
    nodes: {
      ...
      counter: {
        lines: [
          "전자를 잡아당기는 힘이 서로 다르면, 힘이 센 쪽이 전자를 가져간단다.",
          "염소는 그 힘이 3.16이야. 그보다 약한 원소는 빼앗기고, 센 원소는 오히려 빼앗을 수 있지.",
    ...
    nodes: {
      crossroads: {
        lines: [
          ...
          "…서쪽 폐허의 늙은 기사도 만나 봤나? 저쪽 말도 듣고 정해라. 나는 강요하지 않는다.",
        ],
        choices: [
          {
            text: "군단과 함께 서겠습니다",
