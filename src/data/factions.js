...
export const FACTIONS = {
  legion: {
    ...
    desc: "철이 이끄는 대장장이 무리. 불을 다루는 힘으로 신분의 벽을 부수려 한다.",
  },
  noblesse: {
    id: "noblesse",
    name: "귀금속 귀족",
  ...
  noble_gas: {
    ...
    desc: "이미 자리가 꽉 차 아무것과도 섞이지 않는다. 불간섭 회의소와 아르곤 고원 마을을 다스린다.",
  },
  affinity: {
    id: "affinity",
    name: "결원단",
    leader: "cl",
    color: 0xa8d145,
    creed: "하나만 더 있으면 나도 저들처럼 된다",
    desc: "염소가 이끄는 위험한 무리. 딱 하나가 모자라서, 그 하나를 채우려 무엇이든 한다.",
    hostile: true,
  },
  exiled: {
    id: "exiled",
