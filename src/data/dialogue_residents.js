...
export const RESIDENT_DIALOGUES = {
  ...
  zn: {
    ...
    nodes: {
      intro: {
        lines: [
          "어, 손님? 잠깐만. 이 난간에 칠만 마저 하고.",
          "나는 아연. 쇠붙이에 겉옷을 입혀 주는 일을 해.",
        ],
        choices: [
          { text: "철 옆에 자주 계시던데요", to: "sacrifice", effect: { codex: "zn" } },
          { text: "무슨 칠이에요?", to: "sacrifice", effect: { codex: "zn" } },
        ],
      },
      sacrifice: {
        lines: [
          "…들켰네. 철은 나보다 귀한데 나보다 쉽게 삭거든.",
          "그래서 내가 겉에 붙어 있으면 산소가 철 대신 나를 먼저 먹어.",
          "별거 아니야. …너한테도 조금 빌려줄게. 누군가를 대신 맞아 주는 힘.",
        ],
        choices: [{ text: "고마워요", to: null, effect: { element: "zn", rep: ["neutral", 5] } }],
      },
      repeat: { lines: ["칠이 마르려면 아직 멀었어. 만지지 마."], choices: [{ text: "알겠어요", to: null }] },
    },
  },
  ...
  pb: {
    ...
    nodes: {
      intro: {
        lines: [
          "거기 서. 그 선 넘어오지 마. …아직 벽이 안 올라갔어.",
          "나는 납. 눈에 안 보이는 걸 막는 벽을 쌓아. 무거운 게 내 재주야.",
        ],
        choices: [
          { text: "안 보이는 걸요?", to: "eyes", effect: { codex: "pb" } },
          { text: "무슨 역을 하세요?", to: "eyes", effect: { codex: "pb" } },
        ],
      },
      eyes: {
        lines: [
          "다들 그러더라. 뭘 막는지 안 보인다고. 안 보이는 걸 막으니까 그렇지.",
    ...
    nodes: {
      intro: {
        lines: [
          ...
          "공기의 대부분이 저예요. 그런데 저는 웬만해선 아무것도 안 합니다.",
        ],
        choices: [
  ...
  o: {
    ...
    nodes: {
      intro: {
        lines: [
          "…오셨군요. 산소라 합니다. 숨을 나눠 주는 일을 하지요.",
          "숨 쉬는 것도, 쇠가 삭는 것도, 불이 붙는 것도 전부 저를 거칩니다.",
        ],
        choices: [
  ...
  ne: {
    ...
    nodes: {
      verdict: {
        lines: [
          "…밤에만 문을 연다. 낮에는 내 불빛이 안 보이니까.",
          "어느 편에도 서지 않았다더군. 나와 같은 방식이다.",
  ...
  sb: {
    ...
    nodes: {
      intro: {
        lines: [
          "밤길에 혼자라니, 위험하지 않니? …아, 나는 안티모니. 활자를 부어 만들어.",
          "쇳물은 굳으면 쪼그라들거든. 나는 반대로 조금 부풀어. 그래서 글자 획이 꽉 찬다.",
        ],
        choices: [
      ...
      night: {
        lines: [
          ...
          "나는 금속도 비금속도 아니야. 그 어중간함 덕에 이쪽저쪽 일을 다 해.",
  ...
  nb: {
    ...
    nodes: {
      intro: {
        lines: [
          "춥지? 더 식혀야 해. 아직 멀었어.",
          "나이오븀이다. 저기 계신 분이 탄탈럼. 나랑 같은 돌에서 나왔지.",
        ],
        choices: [
          { text: "같은 돌이요?", to: "under", effect: { codex: "nb" } },
          { text: "탄탈럼 씨는 왜 안 움직이세요?", to: "under", effect: { codex: "nb" } },
        ],
      },
      under: {
        lines: [
          "우리 둘은 늘 같은 광석에 붙어 나와. 갈라내기가 지독하게 어렵지. 형제라고들 해.",
          "탄탈럼 님은 자리를 안 뜨셔. 그래서 내가 대신 돌아다니지. 나는 아주 차게 식히면 저항이 없어지거든.",
          "…힘 필요해? 줄게. 내가 최고니까.",
        ],
  ...
  ta: {
    ...
    nodes: {
      intro: {
        lines: [
          "…이 그릇 좀 보게. 탄탈럼이야. 뭘 담아도 끄떡없는 걸 만들지.",
          "나이오븀과 나는 늘 같은 돌에서 나와. 갈라내기가 몹시 어렵다더군.",
        ],
        choices: [
          { text: "왜 안 움직이세요?", to: "curse", effect: { codex: "ta" } },
      ...
      curse: {
        lines: [
          ...
          "그래서 몸속에 넣어도 탈이 안 나. 의사들이 나를 뼈에 쓴다더군. 안 변하는 게 쓸모가 된 셈이지.",
  ...
  co: {
    ...
    nodes: {
      intro: {
        lines: [
          "이 파랑 좀 보세요! 아, 실례. 코발트라 합니다. 물감을 팔지요.",
          "조금만 넣어도 이렇게 진해집니다. 천 년 전 그릇에도 이 파랑이 남아 있지요.",
        ],
        choices: [
  ...
  ni: {
    ...
    nodes: {
      intro: {
        lines: [
          "니켈이다. 겉에 한 겹 씌워 주는 일을 하지. …코발트는 오늘도 물감을 팔고 있더군.",
    ...
    nodes: {
      intro: {
        lines: [
          ...
          "…어머, 손님? 베릴륨이에요. 창을 굽는 사람이죠.",
        ],
        choices: [
          { text: "그게 왜 신기해요?", to: "barrier", effect: { codex: "be" } },
          { text: "창 하나 살게요", to: "barrier", effect: { codex: "be" } },
        ],
      },
      barrier: {
        lines: [
          ...
          "나는 가볍고 단단해요. 우주선 창에도 쓰죠. 조금 빌려 드릴게요.",
        ],
        choices: [{ text: "고마워요", to: null, effect: { element: "be", rep: ["neutral", 5] } }],
      },
      repeat: { lines: ["창은 아직 굽는 중이에요. 조금만 기다려요."], choices: [{ text: "네", to: null }] },
    },
  },
    ...
    nodes: {
      intro: {
        lines: [
          ...
          "금·은·나는 성질이 닮았어. 잘 늘어나고 전기가 잘 통하지. 그래서 다들 나를 써.",
        ],
        choices: [
  ...
  ti: {
    ...
    nodes: {
      intro: {
        lines: [
          "자, 어디 봐. 부러졌네. 움직이지 말고 가만히 있어.",
          "…아, 다친 데 없구나? 나는 타이타늄. 부러진 걸 이어 붙이는 일을 해.",
        ],
        choices: [
          { text: "잘 붙나요?", to: "clean", effect: { codex: "ti" } },
          { text: "거인이시네요", to: "clean", effect: { codex: "ti" } },
        ],
      },
      clean: {
        lines: [
          "몸이 나를 밀어내지 않거든요. 가볍고 튼튼하고 삭지도 않고요. 비행기도 나로 만들어요!",
      ...
      repeat: { lines: ["붙였으면 끝까지 붙어 있어야지!"], choices: [{ text: "…네", to: null }] },
    },
  },
  ...
  sc: {
    ...
    nodes: {
      intro: {
        lines: [
          "잠깐. 거기 서. …아, 사람이구나. 스칸듐이야. 이 빈자리를 지켜.",
          "옛날에 어떤 학자가 여기 뭔가 올 거라고 적어 뒀대. 한참 뒤에 온 게 나야.",
        ],
        choices: [
          { text: "빈자리요?", to: "bat", effect: { codex: "sc" } },
          { text: "누굴 기다려요?", to: "bat", effect: { codex: "sc" } },
        ],
      },
      bat: {
        lines: [
          ...
          "힘 줄게. 네 자리도 어딘가에 비어 있을 거야. 아직 아무도 안 채웠을 뿐이지.",
        ],
        choices: [{ text: "알겠어요", to: null, effect: { element: "sc", rep: ["legion", 5] } }],
      },
      repeat: { lines: ["아직 아무도 안 왔어. 기다리는 건 익숙해."], choices: [{ text: "네", to: null }] },
    },
  },
  ...
  ag: {
    ...
    nodes: {
      intro: {
        lines: [
          "…이 숲까지 오는 사람은 드문데. 은이야. 저 너머가 내 공방이고.",
          "전기가 지나가는 길은 내가 제일 빨라. 근데 비싸서 다들 구리를 쓰지. 서운하진 않아.",
        ],
        choices: [
  ...
  rn: {
    ...
    nodes: {
      intro: {
        lines: [
          "어, 손님? 여기 오래 있으면 안 되는데. …라돈이에요. 재는 일을 해요.",
          "눈에 안 보이고 냄새도 없어요. 재지 않으면 있는 줄도 모르죠. 창문 좀 열어 둘래요?",
        ],
        choices: [
  ...
  s: {
    ...
    nodes: {
      intro: {
        lines: [
          "누가 내 잠을 깨우나. …네가 그 이름 없는 아이냐?",
          "황이다. 이 땅 밑에서 김을 뿜지. 내가 숨을 쉬면 온천이 끓는다.",
        ],
        choices: [
          { text: "김이 뜨거워요", to: "king", effect: { codex: "s" } },
  ...
  bi: {
    ...
    nodes: {
      intro: {
        lines: [
          "…저기 …내 얼굴에 뭐가 묻었니…?",
          "…아. 비스무트야. 이 계단… 내가 쌓았어. 굳으면 겉에 무지개가 돈다고들 하더라.",
        ],
        choices: [
